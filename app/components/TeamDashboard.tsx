...
function ClubBadge() { return <span className="club-badge" aria-label="SV Twello"><span className="club-badge-mark"><img src="./sv-twello-mark.png" alt="" aria-hidden="true"/><span className="club-badge-name"><b>SV</b><span>TWELLO</span></span></span></span>; }
