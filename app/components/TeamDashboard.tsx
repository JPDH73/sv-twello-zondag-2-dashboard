...
function DashboardView({ data, program, onNavigate }: { data: TeamData; program: Match[]; onNavigate: (view: View) => void }) {
  ...
  return <>
    ...
    <div className="loser-grid">
      <Loser label="Minste trainingen" awardTitle="Trainingsspook" players={leastTraining} score={(player) => player.training.attended} displayName={displayName} maxNames={5} showScore={false} inlineNames/>
