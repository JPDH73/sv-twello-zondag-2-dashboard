...
function ClubBadge() { return <span className="club-badge" aria-label="SV Twello"><span className="club-badge-mark"><img src="./sv-twello-badge-v2.png" alt="" aria-hidden="true"/></span></span>; }
