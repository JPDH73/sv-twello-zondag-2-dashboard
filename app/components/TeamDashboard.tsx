...
function TeamLogo({ team }: { team: string }) { const source = teamLogos[team.trim().toLocaleLowerCase("nl")]; return source ? <img className="fixture-team-logo" src={source} alt="" aria-hidden="true"/> : null; }
